...
int main(int argc, char *argv[])
{
	...
	//if ((SourceFilePtr = fopen("C:\\M68kV6.0-640by480\\Programs\\M68kdebugmonitor.hex", "r")) == NULL)	{
	if ((SourceFilePtr = fopen("C:\\IDE68k\\IDE 68000 Projects\\M68kdebugmonitor.hex", "r")) == NULL)	{
		fprintf(stderr, "Cannot Open S-Record File 'C:\\M68kV6.0-640by480\\M68kdebugmonitor.hex' for conversion to '.MIF' format\n");
		fprintf(stderr, "Hit any key to exit.....");
		getch();
		return 0;
	}

	//if ((DestFilePtr = fopen("C:\\M68kV6.0-640by480\\Programs\\M68kdebugmonitor.mif", "w")) == NULL)	{
	if ((DestFilePtr = fopen("C:\\IDE68k\\IDE 68000 Projects\\M68kdebugmonitor.mif", "w")) == NULL)	{
		fprintf(stderr, "Cannot Open/Create file 'C:\\M68kV6.0-640by480\\Programs\\M68kdebugmonitor.mif' to store output of file conversion\n");
		fprintf(stderr, "Hit any key to exit.....");
		getch();
		return 0;
	}
